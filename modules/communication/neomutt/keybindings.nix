...
in
{
  config.programs.neomutt.binds = lib.mkIf config.communication.neomutt.enable [
    ...
    (bind [ "index" ] "q" "noop")
    (bind [ "index" ] "\\Ch" "help")
    # Opening a message is reserved for Enter/Return.
    (bind [ "index" ] "h" "noop")
