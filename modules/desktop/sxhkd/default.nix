  ...
  config = lib.mkIf config.desktop.enable {
    ...
    services.sxhkd.keybindings =
      ...
      lib.mkMerge [
        ...
        (createKeybinding "s" "Show keybindings."
        ...
        (createKeybinding "r" "Application launcher." "rofi -show drun")

        (createKeybinding "t" "Launch terminal." "kitty")

        (createKeybinding "f" "Launch File Manager."
